...
MODIS_dir = '/Users/rsspenc3/Desktop/SEAC4RS/DATA/MODIS_3K_Data/Aqua'
ext = 'hdf'
#------------------------------------------------------------------------------
...
if os.path.exists('eMAS_vs_MODIS_3KAqua_Compiled.csv'):
    os.remove('eMAS_vs_MODIS_3KAqua_Compiled.csv')
with open('eMAS_vs_MODIS_3KAqua_Compiled.csv', "w") as output:  
    output.write(labels+'\n')  
