...
for i in range(314, len(path_names), 3):
    print 'Computing file...', i
    ...
    np.savetxt("DATA/Dist_Cloud_Rasters_L2CLD_ALL/{0}.csv".format(eMAS_file[-55:-4]), cld_dist_lowres, delimiter=",")
    np.savetxt("DATA/Dir_Cloud_Rasters_L2CLD_ALL/{0}.csv".format(eMAS_file[-55:-4]), cld_direction_lowres, delimiter=",")
